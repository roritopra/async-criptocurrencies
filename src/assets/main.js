...
function translateElements(language) {
  var translatableElements = document.querySelectorAll('.translatable');

  for (var i = 0; i < translatableElements.length; i++) {
    var element = translatableElements[i];
    var translation = getTranslation(element.dataset.translationKey, language);
